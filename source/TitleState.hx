...
class TitleState extends MusicBeatState
{
	...
	override public function create():Void
	{
		...
		if (!sys.FileSystem.exists(Main.getDataPath() + "assets/sm"))
			sys.FileSystem.createDirectory(Main.getDataPath() + "assets/sm");
		#end
	...
	override function beatHit()
	{
		...
		switch (curBeat)
		{
			...
			case 5:
				if (Main.watermarks)
					createCoolText(['Made in', 'And thanks to']);
				else
			...
			// credTextShit.text += '\nto do';
			case 15:
				addMoreText('trolling'); // credTextShit.text += '\nsome Trolling';
