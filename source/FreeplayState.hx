...
class FreeplayState extends MusicBeatState
{
	...
	override function create()
	{
		...
		#if sys
		for(i in FileSystem.readDirectory(Main.getDataPath() + "assets/sm/"))
		{
			trace(i);
			if (FileSystem.isDirectory(Main.getDataPath() + "assets/sm/" + i))
			{
				trace("Reading SM file dir " + i);
				for (file in FileSystem.readDirectory(Main.getDataPath() + "assets/sm/" + i))
				{
					if (file.contains(" "))
