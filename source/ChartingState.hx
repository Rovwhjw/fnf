...
class ChartingState extends MusicBeatState
{
	...
	var notetypetext:FlxText = new FlxText(-200, 0, 0, "Charting: ", 32);
	...
	**/
	...
	private function addNote(?n:Note):Void
	{
		...
		if (n != null)
			section.sectionNotes.push([n.strumTime, n.noteData, n.sustainLength, noteStyle]);
		else
			section.sectionNotes.push([noteStrum, noteData, noteSus, noteStyle]);
